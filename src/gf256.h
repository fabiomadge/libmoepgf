...
void mulrc256_imul_avx512f(uint8_t *region, uint8_t constant, size_t length);
...
void maddrc256_imul_avx512f(uint8_t *region1, const uint8_t *region2, uint8_t constant, size_t length);
...
void maddrc256_shuffle_avx512bw(uint8_t *region1, const uint8_t *region2, uint8_t constant, size_t length);

void mulrc256_imul_sse2(uint8_t *region, uint8_t constant, size_t length);
void mulrc256_imul_avx2(uint8_t *region, uint8_t constant, size_t length);
void mulrc256_imul_sse512f(uint8_t *region, uint8_t constant, size_t length);
...
void mulrc256_shuffle_avx512bw(uint8_t *region, uint8_t constant, size_t length);
#endif
