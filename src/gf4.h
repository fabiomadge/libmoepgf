...
void mulrc4_imul_avx512f(uint8_t *region, uint8_t constant, size_t length);
...
void mulrc4_shuffle_avx512bw(uint8_t *region, uint8_t constant, size_t length);
...
void maddrc4_imul_avx512f(uint8_t *region1, const uint8_t *region2, uint8_t constant, size_t length);
...
void maddrc4_shuffle_avx512bw(uint8_t *region1, const uint8_t *region2, uint8_t constant, size_t length);
#endif
